...
internal sealed class CreateCreditPackageValidator : AbstractValidator<CreateCreditPackageCommand>
{
    public CreateCreditPackageValidator()
    {
        RuleFor(c => c.Name)
        ...
        RuleFor(c => c.Currency)
            ...
            .Matches("^[A-Za-z]{3}$").WithErrorCode("billing.package.currency.invalid");
