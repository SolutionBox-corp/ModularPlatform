...
/// <paramref name="Company"/> is a case-insensitive contains. Name/e-mail are encrypted at rest and cannot be
/// filtered by value (a name blind index is a later enhancement); <paramref name="Email"/> matches exactly via the
/// blind-index hash.
/// </summary>
