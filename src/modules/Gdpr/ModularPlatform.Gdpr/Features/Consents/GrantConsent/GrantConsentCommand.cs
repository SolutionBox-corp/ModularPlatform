...
public sealed record GrantConsentCommand(Guid UserId, string ConsentType, string? PolicyVersion = null) : ICommand<GrantConsentResponse>;
...
public sealed record GrantConsentRequest(string ConsentType, string? PolicyVersion = null);
