...
namespace ModularPlatform.Marketing.Persistence.Migrations
{
    ...
    [Migration("20260630190433_AddMarketingListIndexes")]
    partial class AddMarketingListIndexes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ModularPlatform.Marketing.Entities.MarketingAnalysis", b =>
                {
                    ...
                    b.HasIndex("UserId", "AnalyzedAt", "Id")
                        .IsDescending(false, true, true);
            ...
            modelBuilder.Entity("ModularPlatform.Marketing.Entities.MetricSnapshot", b =>
                {
                    ...
                    b.HasIndex("UserId", "Source", "RecordedAt", "Id")
            ...
            modelBuilder.Entity("ModularPlatform.Marketing.Entities.VibeConversation", b =>
                {
                    ...
                    b.HasIndex("UserId", "LastMessageAt", "CreatedAt", "Id")
