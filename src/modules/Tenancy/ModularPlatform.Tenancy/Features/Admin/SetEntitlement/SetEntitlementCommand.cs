...
/// </summary>
public sealed record SetEntitlementCommand(Guid TenantId, string ModuleKey, bool Enabled, string? Tier)
    : ICommand<SetEntitlementResponse>;

public sealed record SetEntitlementResponse(Guid TenantId, string ModuleKey, bool Enabled);

public sealed record SetEntitlementRequest(bool Enabled, string? Tier);
