...
using ModularPlatform.Tenancy.Features.Admin.ListTenantInvites;
using ModularPlatform.Tenancy.Features.Admin.ListTenants;
using ModularPlatform.Tenancy.Features.Admin.ProvisionTenant;
using ModularPlatform.Tenancy.Features.Admin.RevokeTenantInvite;
...
using ModularPlatform.Tenancy.Features.PlatformBilling.GetPlatformPlans;
...
public sealed class TenancyModule : IModule
{
    ...
    public void MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapListTenantInvites();
        endpoints.MapRevokeTenantInvite();
        endpoints.MapGetPlatformBillingStatus();
        endpoints.MapGetPlatformPlans();
