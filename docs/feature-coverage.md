...
**Testy:** JobFailureMetricsTests.Recording_a_failure_increments_the_platform_jobs_failures_counter; JobFailureMetricsTests.JobWasExecuted_with_exception_logs_and_records_the_failed_job; JobsHostWiringTests.Platform_messaging_health_job_disallows_concurrent_execution; Jobs_host_composes (HostBootTests)
**Test gaps:** No test asserts the health trigger's cron is interpreted in UTC (the Law #7 fix); No test for WaitForJobsToComplete wiring
