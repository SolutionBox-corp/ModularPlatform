...
import { ContactDetail } from "@/features/crm/components/contact-detail";

export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("crm");
  return { title: t("page.contactMetaTitle") };
}
...
export default async function ContactDetailPage({ params }: PageProps) {
  ...
  void queryClient.prefetchQuery(crmQueries.contact(id));
  void queryClient.prefetchQuery(crmQueries.interactions(id));
