...
import { TaskDetail } from "@/features/crm/components/task-detail";

export async function generateMetadata(): Promise<Metadata> {
  const t = await getTranslations("crm");
  return { title: t("tasks.detailMetaTitle") };
}
...
export default async function TaskDetailPage({ params }: PageProps) {
  ...
  void queryClient.prefetchQuery(crmQueries.task(id));
  void queryClient.prefetchQuery(crmQueries.taskComments(id));
