...
| PRIV-22 | Case-sensitive mismatch does not submit | Given the user types "DELETE MY ACCOUNT" without trim | Then the button remains disabled (relies on toLowerCase normalization — passes as a boundary case) | P1 | edge | manual |
